...
public class HERO : Photon.MonoBehaviour
{
    ...
    public string currentPlayingClipName()
    {
        foreach (AnimationState animationState in base.animation)
        {
            if (base.animation.IsPlaying(animationState.name))
            {
    ...
    {
        if (((base.animation.IsPlaying(this.standAnimation) || base.animation.IsPlaying("run")) || base.animation.IsPlaying("run_sasha")) && (((this.currentBladeSta != this.totalBladeSta) || (this.currentBladeNum != this.totalBladeNum)) || (((this.currentGas != totalGas) || (this.leftBulletLeft != this.bulletMAX)) || (this.rightBulletLeft != this.bulletMAX))))
        {
    ...
    public void setStat()
    {
        ...
        totalGas = this.currentGas = this.setup.myCostume.stat.GAS;
    ...
    {
        float num = this.currentGas / totalGas;
        float num2 = this.currentBladeSta / this.totalBladeSta;
        this.cachedSprites["gasL1"].fillAmount = this.currentGas / totalGas;
        this.cachedSprites["gasR1"].fillAmount = this.currentGas / totalGas;
        if (!this.useGun)
        {
    ...
    public void update()
    {
        ...
        ExitGames.Client.Photon.Hashtable propertiesToSet = new ExitGames.Client.Photon.Hashtable();
        propertiesToSet.Add(PhotonPlayerProperty.current_gas, this.currentGas);
    }
